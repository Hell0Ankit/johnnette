...
import Slide from "../../assets/img/JM1/JM1_Hero.webp";
  ...
  const slides = [
    {
      ...
      subtitle: "OVERVIEW",
      data: [
        ["Wingspan", "140 cm <span class='text-[var(--text-secondary)] text-sm'> / 1.4 m </span>"],
        ["Length", "124 cm <span class='text-[var(--text-secondary)] text-sm'>/ / 1.24 m </span>"],
        ["Height", "25 cm <span class='text-[var(--text-secondary)] text-sm'>/ / 0.25 m </span>"],
        ["Aircraft Weight", "3.8 kg"],
        ["PAYLOAD", "Static Camera"],
        ["Warhead", "500 gms"],
        ["Design Patented", "Serial No 423708 - 001"],
      ],
      img: Slide
    },

    {
      ...
      data: [
        ...
        ["Operational Altitude  (AGL)", "500 m AGL"],
        ["Max Launch Altitude (AGL) ", "17000 ft"]
      ],
      img: Slide
    },

    {
      ...
      data: [
        ...
        ["Range", "05 km"],
        ["Operating Temperature", "-20° C to 50° C (Field Tested)"],
        ["Launch/Recovery", "Cannister Launch, Hand Launch/ Net Recovery"],
      ],
      img: Slide
    },

    {
      subtitle: "FEATURES",
      list: [
        " NAVIGATION: GPS and On Board Computer",
        " Operational Altitude Upto 500m",
        " Software Johnnette GCS Closed Source Encrypted",
        "WIND RESISTANCE 40kmph",
        "GCS MIL STD All weather laptop integrated with our software",
        "Pneumatic Canister Launch makes it easy to deploy",
        "Highly affordable alternative to neutralize lightly armoured vehicles and enemy bunkers",
      ],
      img: Slide
    },

    {
      ...
      list: [
        "Easy Operations",
        "Precision Strike",
        "Highly affordable alternative to Missiles",
        "Can be used in amphibious warfare",
        "cost due to its expendable nature of operation to fire and forget",
        "Indigenous Content: 85%",
        "Reusable Aerial Platform",
        "Easy Backpack Transportation (Optional)",
        "Abort eature to reduce collateral damage",
        "Low operational set up time making it easy and quick to deploy",
      ],
      img: Slide
    }
  ];
